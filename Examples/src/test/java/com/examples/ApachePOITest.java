...
public class ApachePOITest {
    ...
    static void init() throws IOException {
        try (XWPFDocument doc = new XWPFDocument()) {
            ...
            try(FileOutputStream fileOutputStream = new FileOutputStream(new File("WordOutput.docx"))) {
    ...
    void testPOI() throws IOException {
        ...
        try (XWPFDocument wordDocument = new XWPFDocument(
                Files.newInputStream(Paths.get("WordOutput.docx")))) {
        ...
        try(FileOutputStream fileOutputStream = new FileOutputStream(new File("ExcelOutput.xlsx"))) {
